This project is no longer useful as Discord ended the Active Developer badge. The source code remains available for
historical purposes.
...
Go to ~~[defunct link]~~ and follow the steps to get your badge. Nothing to download. :tada:
...
> [!WARNING]
> You'll be invited to enter application secret credentials in the app. The credentials are used locally
